...
# --- Configuration ---
INPUT_PDF_PATH = "/home/kayden/Desktop/python_projects/ExamBOT/metal-mining/Lec4-Metal Mining Methods.pdf"   # <--- REPLACE with the path to your original PDF
OUTPUT_PDF_PATH = "lec4_underground_mine_development.pdf" # Name for the new PDF after trimming
